                ...
                <div className="mx-auto w-full max-w-screen-xl px-6 lg:px-10">
                    ...
                    <div className="relative mx-auto h-[520px] w-full max-w-4xl">
                        {cards.map((c, i) => {
                            ...
                            const yCollapse = useTransform(scrollYProgress, [collapseStart, collapseEnd], [0, -22])
                            const scaleCollapse = useTransform(scrollYProgress, [collapseStart, collapseEnd], [1, 0.965])
